...
# aliases
alias ls='ls --color'
alias intj='~/.local/share/JetBrains/Toolbox/apps/intellij-idea-community-edition/bin/idea.sh'
...
export JAVA_HOME=/home/rickjhoppe/.sdkman/candidates/java/17.0.8-zulu
